...
**TKTK: Describe ferguson-solutions here.**
...
```
cd ferguson-solutions
mkvirtualenv --no-site-packages ferguson-solutions
...
```
* * * * * ubuntu bash /home/ubuntu/apps/ferguson_solutions/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test 
```
...
|--------|------|-----|-----|--------|--------|
|ferguson-solutions|tweet|`location`||||
|ferguson-solutions|facebook|`location`||||
|ferguson-solutions|email|`location`||||
|ferguson-solutions|new-comment||||
|ferguson-solutions|open-share-discuss||||
|ferguson-solutions|close-share-discuss||||
|ferguson-solutions|summary-copied||||
|ferguson-solutions|featured-tweet-action|`action`||``tweet_url``|
|ferguson-solutions|featured-facebook-action|`action`||``post_url``|
